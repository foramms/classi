    ...
    <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
      <div className = "flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="flexCenter gap-6">
          ...
          <p className="bold-16 md:bold-20 text-blue-70">{peopleJoined}</p>
  ...
  return (
    <section className="2xl:max-container relative flex flex-col py-20 lg: mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        ...
        title = "Work Towards Your Degree"
        subtitle = "Build knowledge and your network to support your educational goals "
        peopleJoined = "50+ Students Joined"
        />
      </div>
